    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-8 col-md-6 col-lg-5 footer_menuList">
                <div class="heading row m0"><img src="images/logo/4.png" alt=""></div>
            ...
            <div class="col-sm-4 col-md-6 col-lg-3 footer_address pull-right">
                ...
                <div class="row address m0">
                    <div class="media address_line">
                        ...
                        <div class="media-body address_text">BLK Super Specialty Hospital, New Delhi<br>India 110005</div>
                    </div>
                    <div class="media address_line">
                        <div class="media-left icon"><i class="fa fa-envelope"></i></div>
                        <div class="media-body address_text">drssrivastava@rediffmail.com</div>
                    </div>
                    <div class="media address_line">
                        <div class="media-left icon"><i class="fa fa-phone"></i></div>
                        <div class="media-body address_text">+91 99102-13855</div>
                    </div>
                </div>
            </div>
        </div>
